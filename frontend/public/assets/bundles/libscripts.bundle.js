(!(function (e, t) {
    ...
    special: {
      ...
      click: {
        ...
        trigger: function (e) {
          e = this || e;
          return (
            ue.test(e.type) && e.click && k(e, 'input') && Ee(e, 'click'),
            !0
          );
        },
        _default: function (e) {
  ...
  (T.extend({
    ...
    clone: function (e, t, n) {
      ...
      return (
        0 < (s = pe(u, 'script')).length && ge(s, !d && pe(e, 'script')),
        u
      );
    },
  ...
  (function (e, t) {
    ...
    function Ke(e) {
      return ((Be(e) ? e.ownerDocument : e.document) || window.document)
        .documentElement;
    }
    function Ge(e) {
      return 'html' === $e(e)
