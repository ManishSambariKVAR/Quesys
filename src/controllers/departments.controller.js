...
async function registerDepartment(req, res) {
  ...
  try {
    await departmentsService.registerDepartment(department, kioskKey, depPrefix, kioskId);
...
async function updateDepartment(req, res) {
  ...
  try {
    await departmentsService.updateDepartment(id, department, kioskKey, depPrefix, kioskId);
