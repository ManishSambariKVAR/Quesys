                        ...
                        <tbody>
                            {kiosks.map((k, i) => (
                                <tr key={k.id}>
                                    ...
                                    <td><div className="um-input-container"><input type="text" value={k.kiosk_id} readOnly /></div></td>
                                    <td><div className="um-input-container"><input type="text" value={new Date(k.registration_date).toLocaleDateString()} readOnly /></div></td>
                                    <td>
                                        <button type="button" className="um-delete-button" onClick={() => handleDelete(k.id)}>
                            ...
                            {kiosks.length === 0 && (
                                <tr>
                                    <td colSpan={4} style={{ textAlign: 'center' }}>No Kiosks registered</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
