...
async function registerCounter(req, res) {
  ...
  try {
    await countersService.registerCounter(counter, active, displayid, buzzer_time, buzzer_active, blink, ipaddress);
...
async function updateCounter(req, res) {
  ...
  try {
    await countersService.updateCounter(id, counter, active, displayid, buzzer_time, buzzer_active, blink, ipaddress);
