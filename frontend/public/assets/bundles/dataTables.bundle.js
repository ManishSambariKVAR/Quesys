    ...
    function $(t) {
      ...
      if (
        ...
        for (l = (t = t.aoFooter[(s = 0)]).length; s < l; s++)
          (((c = i[s]).nTf = t[s].cell),
            c.sClass && P(c.nTf).addClass(c.sClass));
    }
    function E(t, e, n) {
      var r,
        a = [],
          ...
          if (
            ...
            if (
              ...
              for (a = 0, o = t.columns.length; a < o; a++)
                ((e = t.columns[a]).visible !== R &&
                  (i[a].bVisible = e.visible),
                  e.search !== R &&
      ...
      P.each(
        ...
        function (t, e) {
          ((Gt.type.order[t + n + '-pre'] = e),
            t.match(/^html\-/) &&
              (Gt.type.search[t + n] = Gt.type.search.html));
        }
      );
    }
    function e(e) {
