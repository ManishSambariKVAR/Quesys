              ...
              <tbody>
                {counters.map((c, i) => (
                  <tr key={c.id}>
                    ...
                    <td>
                      <div className="um-input-container">
                        <input type="text" value={c.counter} readOnly />
                      </div>
                    </td>
                    <td>
                      <div className="um-input-container">
                        <input type="text" value={c.active} readOnly />
                      </div>
                    </td>
                    <td>
                      <div className="um-input-container">
                        <input type="text" value={c.displayid} readOnly />
                      </div>
                    </td>
                    <td>
                      <div className="um-input-container">
                        <input type="text" value={c.buzzer_active} readOnly />
                      </div>
                    </td>
                    <td>
                      <div className="um-input-container">
                        <input type="text" value={c.buzzer_time} readOnly />
                      </div>
                    </td>
                    <td>
                      <div className="um-input-container">
                        <input type="text" value={c.blink} readOnly />
                      </div>
                    </td>
                    <td>
                      <div className="um-input-container">
                        <input type="text" value={c.ipaddress} readOnly />
                      </div>
                    </td>
                    <td>
                      <button
                    ...
                    <td>
                      <div className="um-input-container">
                        <input
                          ...
                          onChange={(e) =>
                            setAddForm({ ...addForm, counter: e.target.value })
                          }
                          required
                        />
                      </div>
                    ...
                    <td>
                      <div className="um-input-container">
                        <input
                          ...
                          onChange={(e) =>
                            setAddForm({ ...addForm, active: e.target.value })
                          }
                        />
                      </div>
                    </td>
                    ...
                    <td>
                      <div className="um-input-container">
                        <input
                          type="text"
                          placeholder="Buzzer"
                          value={addForm.buzzer_active}
                          onChange={(e) =>
                            setAddForm({
                              ...addForm,
                              buzzer_active: e.target.value,
                            })
                          }
                        />
                      </div>
                    ...
                    <td>
                      <div className="um-input-container">
                        <input
                          type="text"
                          placeholder="Time"
                          value={addForm.buzzer_time}
                          onChange={(e) =>
                            setAddForm({
                              ...addForm,
                              buzzer_time: e.target.value,
                            })
                          }
                        />
                      </div>
                    ...
                    <td>
                      <div className="um-input-container">
                        <input
                          ...
                          value={addForm.blink}
                          onChange={(e) =>
                            setAddForm({ ...addForm, blink: e.target.value })
                          }
                        />
                      </div>
                    </td>
          ...
          <div className="um-modal-content" style={{ width: '90%' }}>
            ...
            >
              ...
              >
                <input
                  type="text"
                  value={editItem.counter}
                  onChange={(e) =>
                    setEditItem({ ...editItem, counter: e.target.value })
                  }
                  placeholder="Counter"
                  required
                />
              ...
              >
                <input
                  type="text"
                  value={editItem.active}
                  onChange={(e) =>
                    setEditItem({ ...editItem, active: e.target.value })
                  }
                  placeholder="Active"
                />
              </div>
              ...
              >
                <input
                  type="text"
                  value={editItem.displayid}
                  onChange={(e) =>
                    setEditItem({ ...editItem, displayid: e.target.value })
                  }
                  placeholder="Display"
                />
              </div>
              ...
              >
                <input
                  type="text"
                  value={editItem.buzzer_active}
                  onChange={(e) =>
                    setEditItem({ ...editItem, buzzer_active: e.target.value })
                  }
                  placeholder="Buzzer Active"
                />
              </div>
              <div
                className="um-input-container modal-input"
              ...
              >
                <input
                  type="text"
                  value={editItem.buzzer_time}
                  onChange={(e) =>
                    setEditItem({ ...editItem, buzzer_time: e.target.value })
                  }
                  placeholder="Buzzer Time"
                />
              </div>
              <div
                className="um-input-container modal-input"
              ...
              >
                <input
                  type="text"
                  value={editItem.blink}
                  onChange={(e) =>
                    setEditItem({ ...editItem, blink: e.target.value })
                  }
                  placeholder="Flash"
                />
              </div>
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    setEditItem({ ...editItem, ipaddress: e.target.value })
                  }
