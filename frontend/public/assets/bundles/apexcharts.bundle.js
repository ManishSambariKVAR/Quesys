                ...
                f =
                  null === n || 0 === n.length
                    ...
                    : h.globals.dom.Paper.gradient(
                        p ? 'radial' : 'linear',
                        function (e) {
                          (Array.isArray(n[l]) ? n[l] : n).forEach(
                            function (t) {
            ...
            return (
              ...
              0 === a.fill.gradient.gradientToColors.length
                ...
                : a.fill.gradient.gradientToColors[s.seriesNumber]
                  ? -1 <
                      (c = r =
                        a.fill.gradient.gradientToColors[
                          s.seriesNumber
                        ]).indexOf('rgba') && (e = T.getOpacityFromRGBA(r))
                  : (c = t),
                ...
                : this.fallbackToCategory
                  ? ((i.labels = i.labels[0]),
                    ...
                    e.xaxis.convertedCatToNumeric &&
                      (new _(e).convertCatToNumericXaxis(
                        e,
                        this.ctx,
                        i.seriesX[0]
                      ),
                    ...
                    (a.dCtx.timescaleLabels && a.dCtx.timescaleLabels.length
                      ...
                      : 'datetime' === r
                        ? a.dCtx.gridPad.right < n &&
                          ...
                          (o.skipLastTimelinelabel = !0)
                        : 'datetime' !== r &&
                          a.dCtx.gridPad.right <
                            n / 2 - a.dCtx.yAxisWidthRight &&
                          !o.rotateXLabels &&
