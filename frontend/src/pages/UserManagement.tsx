...
export default function UserManagement() {
  ...
  const fetchUsers = useCallback(async () => {
    try {
      setLoading(true);
      const res = await api.get<{ users: User[]; departments: Department[] }>(
        '/admin/users'
      );
      ...
      {editUser && (
        <div className="um-modal">
          <div className="um-modal-content">
            <span className="um-close-button" onClick={() => setEditUser(null)}>
              &times;
            </span>
            <h2>Edit User</h2>
